  ...
  return (
    <div className="flex flex-col gap-2">
          ...
          <div key={id} className="flex items-end gap-2">
            ...
            {rowIds.length > 1 ? (
              <button
                ...
                className="mb-0.5 flex h-11 w-9 items-center justify-center rounded-ctl border border-line text-sm text-ink-muted hover:border-alert hover:text-alert"
      ...
      <button
        type="button"
        onClick={addRow}
        className="self-start rounded-ctl border border-dashed border-line-strong px-4 py-2 text-[12px] font-semibold text-teal hover:border-teal"
      >
        + Add another service
      </button>
