...
**Phase 1 (MVP). ~24 of 47 tickets done and reviewed.** For the exact live
...
| D — Profile UI (022–026) | **In progress.** TASK-026 (readiness ring) done. TASK-022 (onboarding chooser) just handed to Hermes — check `docs/TASKS.md` for whether it's back for review yet. TASK-023/024/025 not started. |
...
**Next up, in order:** whatever Hermes reports back on TASK-022 →
TASK-023 → TASK-024 (the big one — "one editor UI serving all three
