...
1. **The OpenRouter key has never been set in `/admin`.** This is the one blocker underneath every AI-driven ticket built today (TASK-049/069/071/073 all note it) — nothing returns real output until this is set. Highest priority next action.
