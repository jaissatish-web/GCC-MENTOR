...
const { extractPdfText } = require('../lib/pdfTextExtract')
...
const text = extractPdfText(minimalPDF)
console.log('Text PDF length:', text.length)
console.log('Result:', text)

const imagePDF = Buffer.from(
  '%PDF-1.4\n1 0 obj<</Type/Catalog/Pages 2 0 R>>endobj\n2 0 obj<</Type/Pages/Kids[3 0 R]/Count 1>>endobj\n3 0 obj<</Type/Page/MediaBox[0 0 612 792]/Parent 2 0 R/Resources<</XObject<</Img 4 0 R>>>>/Contents 5 0 R>>endobj\n4 0 obj<</Type/XObject/Subtype/Image/Width 1/Height 1/ColorSpace/DeviceGray/BitsPerComponent 8/Length 8>>stream\n\x00\x00\x00\x00\x00\x00\x00\x00\nendstream\nendobj\n5 0 obj<</Length 50>>stream\nq 612 0 0 792 0 0 cm /Img Do Q\nendstream\nendobj\nxref\n0 6\n0000000000 65535 f \n0000000009 00000 n \n0000000058 00000 n \n0000000133 00000 n \n0000000288 00000 n \n0000000391 00000 n \ntrailer<</Size 6/Root 1 0 R>>\nstartxref\n496\n%%EOF'
)

const imageText = extractPdfText(imagePDF)
console.log('\nImage PDF length:', imageText.length)
console.log('Result:', imageText || '(empty - correctly rejected)')